...
class Review:
    ...
    def employee_id(self, employee_id):
        if isinstance(employee_id, int) and employee_id:
            employee = Employee.find_by_id(employee_id)
            if employee:
                self._employee_id = employee_id
            else:
                raise ValueError("Employee with the provided employee_id does not exist.")
        else:
            raise ValueError("Employee_id should be an integer.")
